function getVehicles5() {
  ...
  var url5 = "https://cors-anywhere.herokuapp.com/https://www.nicebus.com/NICECustomPages/getjsondata.aspx?getData=getrealtime&route_id=n55,n57,n58,n70,n71,n72,n78,n79,n80";
  ...
  jQuery.ajax({
	  ...
	  var icon = window.location.origin + "/NICEMap/images/RealTime-Inner-bus-lines.png";
          ...
          var marker, point;
          if(Object.keys(markerStore5).length > (data.length * 2)) {
            var objArr = Object.keys(markerStore5);
            for(var i=0; i< objArr.length; i++) {
              ...
              if(selectedMarker.length == 0) {
                markerStore5[objArr[i]].setMap(null);
              }
            }
          }
	      ...
	      scale: 1,
            ...
            if(markerStore5.hasOwnProperty(data[i].vid + 1111)) {
              markerStore5[data[i].vid + 2222].setIcon(outerIcon);
              
              markerStore5[data[i].vid + 1111].animateTo(point,{  easing: "linear",
                                 duration: 10000
                              });
              markerStore5[data[i].vid + 2222].animateTo(point,{  easing: "linear",
                                 duration: 10000
                              });
              ...
              markerStore5[data[i].vid + 1111] = marker;
              marker = new google.maps.Marker({
                position: point,
                map: map,
                icon: outerIcon,
              ...
              markerStore5[data[i].vid + 2222] = marker;              
            }
